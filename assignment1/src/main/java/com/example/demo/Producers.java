...
//    public String processService1(@RequestBody Request request) {
...
//    public String processService2(@RequestBody Request request) {
...
//    public String processService3(@RequestBody Request request) {
